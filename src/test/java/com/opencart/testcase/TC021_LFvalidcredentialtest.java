...
public class TC021_LFvalidcredentialtest extends BaseClass {

	@Test(dataProvider = "validcredentials", groups = "Smoke")
	public void loginWithValidCredentials(String validdata) {

		log.info("***** TC021_LFvalidcredentialtest Started *****");
		...
		log.info("***** TC021_LFvalidcredentialtest Completed *****");
