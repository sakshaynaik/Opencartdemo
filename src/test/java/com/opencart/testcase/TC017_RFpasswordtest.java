...
public class TC017_RFpasswordtest extends BaseClass {

	@Test(dataProvider = "DiffPassword")
	public void registrationWithPassAndEmptyPass(String fieldata) {

		log.info("***** TC0017_RFpasswordtest Started *****");
		...
		log.info("***** TC0017_RFpasswordtest Completed *****");
	}
	...
	public Object[] dataSupplier() {
		...
		JSONArray jsonarray = (JSONArray) jsonobject.get("WithPassandEmptyPass");
