...
public class TC020_LFinvalidcredentialtest extends BaseClass {

	@Test(dataProvider = "invalidcredential", groups = "Smoke")
	public void loginWithInvalidCredentials(HashMap<String, String> hMap) {

		log.info("***** TC020_LFinvalidcredentialtest Started *****");
		...
		log.info("***** TC020_LFinvalidcredentialtest Completed *****");
	...
	public Object[][] dataSupplier() {
		...
		try {
			...
			data = ReadXlsxFile.getTestData(xlsreader, "invaidcredentials", "Data");
