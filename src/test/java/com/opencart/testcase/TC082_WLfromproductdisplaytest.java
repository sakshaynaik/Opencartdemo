...
public class TC082_WLfromproductdisplaytest extends BaseClass {

	@Test(dataProvider = "validcredentials")
	public void wishListFromProductDisplayPage(String validdata) {

		log.info("***** TC082_WLfromproductdisplaytest Started *****");
		...
		Assert.assertTrue(wshlstpg.isDisplayedOniMacImg());
		log.info("iMac Product Displayed On Wishlist Page");

		log.info("***** TC082_WLfromproductdisplaytest Completed *****");
	...
	public Object[] dataSupplier() {
		...
		try {
			String filepath = System.getProperty("user.dir") + "//jsonfiles//wishlist.json";
		...
		JSONArray jsonarray = (JSONArray) jsonobject.get("loginaddtowishlist");
