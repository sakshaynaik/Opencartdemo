...
public class TC023_LFinvalidpasswordtest extends BaseClass{

	@Test(dataProvider = "invalidpassword", groups = "Smoke")
	public void loginWithInvalidPassword(HashMap<String, String> hMap) {
		
		log.info("***** TC023_LFinvalidpasswordtest Started *****");
		...
		log.info("***** TC023_LFinvalidpasswordtest Completed *****");
	}
	...
	public Object[][] dataSupplier() {
		...
		try {
			...
			data = ReadXlsxFile.getTestData(xlsreader, "vaidemailinvalidpassword", "Data");
