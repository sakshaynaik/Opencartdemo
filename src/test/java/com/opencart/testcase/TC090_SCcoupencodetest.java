...
public class TC090_SCcoupencodetest extends BaseClass {

	@Test(dataProvider = "validcredentials")
	public void shoppingCartCoupenTest(String validdata) {

		log.info("***** TC090_SCcoupencodetest Started *****");
		...
		shopcart.clickOnCoupenCodeLink();
		shopcart.enterCoupenTextField(data[2]);
		shopcart.clickOnCoupenContinueButton();
		Assert.assertTrue(shopcart.isDisplayedCoupenInvalidMsg());
		log.info("Invalid Coupen Code Displayed On WebPage: " + shopcart.getCoupenInvalidMsg());

		log.info("***** TC090_SCcoupencodetest Completed *****");
	...
	public Object[] dataSupplier() {
		...
		JSONArray jsonarray = (JSONArray) jsonobject.get("invalidcoupen");
		...
		for (int i = 0; i < jsonarray.size(); i++) {
			...
			Object copn = data.get("coupen");

			arr[i] = brows + "," + prdut + "," + copn;
		}
		return arr;
	}
}
