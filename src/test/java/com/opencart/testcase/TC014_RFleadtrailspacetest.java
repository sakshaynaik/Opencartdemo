...
public class TC014_RFleadtrailspacetest extends BaseClass {

	@Test(dataProvider = "emptyspace")
	public void registratingWithOnlyEmptySpaces(HashMap<String, String> hMap) {

		log.info("***** TC015_RFleadtrailspacetest Started *****");
		...
		log.info("***** TC015_RFleadtrailspacetest Completed *****");
	}

	@DataProvider(name = "emptyspace")
	public Object[][] dataSupplier() {
		...
		try {
			...
			data = ReadXlsxFile.getTestData(xlsreader, "LeadTrailSpace", "Data");
