...
public class TC062_PCsubcategorytest extends BaseClass {

	@Test
	public void productCompareBySubCategory() {

		log.info("***** TC062_PCsubcategorytest Started *****");
		...
		log.info("***** TC062_PCsubcategorytest Completed *****");
	}
}
