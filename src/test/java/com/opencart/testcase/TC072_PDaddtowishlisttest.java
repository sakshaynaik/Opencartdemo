...
public class TC072_PDaddtowishlisttest extends BaseClass {

	@Test(dataProvider = "existdata")
	public void productDisplayProductDetails(HashMap<String, String> hMap) {

		log.info("***** TC072_PDaddtowishlisttest Started *****");
		...
		log.info("***** TC072_PDaddtowishlisttest Completed *****");
