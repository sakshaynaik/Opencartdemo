...
public class TC079_ACbysearchpagetest extends BaseClass {

	@Test(dataProvider = "existdata")
	public void addToCartBySearchPage(HashMap<String, String> hMap) {

		log.info("***** TC079_ACbysearchpagetest Started *****");
		...
		Shoppingcartpage shopcart = prdtpg.clickOnViewCartLink();
		...
		log.info("***** TC079_ACbysearchpagetest Completed *****");
