...
public class TC061_PCbygridviewtest extends BaseClass {

	@Test(dataProvider = "existdata")
	public void productCompareByGridView(HashMap<String, String> hMap) {

		log.info("***** TC061_PCbygridviewtest Started *****");
		...
		log.info("***** TC061_PCbygridviewtest Completed *****");
	}
