...
public class TC037_LOandagainlogintest extends BaseClass {

	@Test(dataProvider = "validata")
	public void logoutAndLoingWithValidCredentials(HashMap<String, String> hMap) {

		log.info("***** TC037_LOandagainlogintest Started *****");
		...
		log.info("***** TC037_LOandagainlogintest Completed *****");
