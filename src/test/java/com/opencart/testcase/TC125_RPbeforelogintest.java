...
public class TC125_RPbeforelogintest extends BaseClass {

	@Test(dataProvider = "validcredentials")
	public void rewardPointsBeforeLogin(String validdata) {

		log.info("***** TC125_RPbeforelogintest Started *****");
		...
		Accountpage accntpg = rewrdpg.clickOnContinueButton();
		Assert.assertTrue(accntpg.isDisplayedEditInfoLink());
		Assert.assertEquals(accntpg.getAccountPageTitle(), accntpg.getAccountPageTitle());
		log.info("Acconts Page Title: " + accntpg.getAccountPageTitle());

		log.info("***** TC125_RPbeforelogintest Completed *****");
	}
