...
public class TC142_CUfromorderpagetest extends BaseClass {

	@Test(dataProvider = "existdata")
	public void contactUsFromOrderSuccessPage(HashMap<String, String> hMap) {

		log.info("***** TC142_CUfromorderpagetest Started *****");
		...
		Contactuspage contactpg = orderconpg.clickOnStoreOwnerLink();
		...
		log.info("***** TC142_CUfromorderpagetest Completed *****");
