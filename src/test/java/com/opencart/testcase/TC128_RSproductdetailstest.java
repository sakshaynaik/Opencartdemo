...
public class TC128_RSproductdetailstest extends BaseClass {

	@Test(dataProvider = "validcredentials")
	public void returnsValidateTheProductDetails(String validdata) {

		log.info("***** TC128_RSproductdetailstest Started *****");
		...
		int view = getRandomIntValue(prdtretnpg.getSizeOfReturnProducts());
		Returninformationpage retuninfopg = prdtretnpg.clickOnRandomReturnProducts(view);
		...
		log.info("***** TC128_RSproductdetailstest Completed *****");
