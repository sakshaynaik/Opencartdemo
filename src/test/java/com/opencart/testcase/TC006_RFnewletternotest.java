...
public class TC006_RFnewletternotest extends BaseClass {

	@Test(dataProvider = "NewsLetterData")
	public void registeringWithNewsLetterAsNoOption(HashMap<String, String> hMap) {

		log.info("***** TC006_RFnewsletternotest Started *****");
		...
		Assert.assertTrue(nwspg.isSelectedNewsletterRadioOptionForNo());
		log.info("NO Option Selected By Default In Newsletter Page");

		log.info("***** TC006_RFnewsletternotest Completed *****");
