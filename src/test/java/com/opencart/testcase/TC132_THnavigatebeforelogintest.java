...
public class TC132_THnavigatebeforelogintest extends BaseClass{

	@Test(dataProvider = "existdata")
	public void transactionHistoryPageNavigationBeforeLogin(HashMap<String, String> hMap) {

		log.info("***** TC132_THnavigatebeforelogintest Started *****");
		...
		log.info("***** TC132_THnavigatebeforelogintest Completed *****");
